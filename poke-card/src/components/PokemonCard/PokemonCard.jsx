                ...
                <div className="box-content bg-white h-96 w-80 justify-evenly rounded-2xl shadow-lg shadow-black relative z-10 pt-10">
                    <div className="flex flex-col items-center z-10 top-0">
                        ...
                        <div className="flex flex-col items-center">
                            <p className="font-bold text-lg py-2 capitalize ">
                                {pokemonData?.name}
                    ...
                    <div className="border-solid border-zinc-300 border-t-2 flex flex-col justify-between z-10">
                        ...
                        <button
                            onClick={handleClickAleatorio}
                            className={
                                (isLoading
                                    ? "bg-slate-700 hover:bg-slate-500 cursor-no-drop"
                                    : "bg-blue-500 hover:bg-blue-700") +
                                " w-48 self-center text-white font-bold py-1 px-4 rounded  text-center"
                            }
                            disabled={isLoading}
                        >
                            Generar Pokemon
