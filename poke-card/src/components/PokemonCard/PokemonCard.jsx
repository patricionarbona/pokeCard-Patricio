      ...
      <>
          ...
          <div className="flex flex-col items-center  z-10 top-0">
            ...
            <div className="bg-white w-48 h-48 rounded-full overflow-hidden">
              ...
              <svg aria-hidden="true" className= {
                "w-full h-full text-gray-200 animate-spin dark:text-gray-600 fill-blue-600 " + ( isLoading? "block" : "hidden ") 
              ...
              :<img src={pokemonData?.sprites.other.dream_world.front_default ?? pokemonData?.sprites.front_default} className="w-full h-full"/>
              }
            </div>
            <div className='flex flex-col items-center'>
              <p className='font-bold text-lg py-2 capitalize '>{pokemonData?.name} 
                <span className='text-gray-500 font-light'>{pokemonData?.stats[0].base_stat}hp</span>
              </p>
              <p className='text-gray-500 font-light pb-2'>
        ...
        <div className= 'border-solid border-zinc-300 border-t-2 flex flex-col justify-between z-10'>
          <div className="h-20 flex justify-around items-center">
              <p className="flex flex-col items-center font-extralight text-xs">
                <span className='font-bold'>{pokemonData?.stats[1].base_stat}K</span>Ataque
              </p>
              <p className="flex flex-col items-center font-extralight text-xs"><span className='font-bold'>
                {pokemonData?.stats[3].base_stat}K</span>Ataque Especial
              </p>
              <p className="flex flex-col items-center font-extralight text-xs"><span className='font-bold'>
                {pokemonData?.stats[2].base_stat}K</span>Defensa
              </p>
          </div>
